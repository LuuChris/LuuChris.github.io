...
function setImage(val){
  if(flag==true){
    ...
    if(val.options[val.selectedIndex].text=="Image 1"){
      ...
      for(var i=0;i<size;i++){
        c[i+1].style.background = 'url("mario.jpg")';
        cell[i].style.left = (i%4*100)+'px';
        cell[i].style.top = (parseInt(i/4)*100) + 'px';
        cell[i].style.backgroundPosition= '-' + cell[i].style.left + ' ' + '-' + cell[i].style.top;
        cell[i].onclick = function(){
      ...
      var c = document.getElementById('gameContainer').childNodes;
      for(var i=0;i<size;i++){
        c[i+1].style.background = 'url("yoshi.jpg")';
        cell[i].style.left = (i%4*100)+'px';
        cell[i].style.top = (parseInt(i/4)*100) + 'px';
        cell[i].style.backgroundPosition= '-' + cell[i].style.left + ' ' + '-' + cell[i].style.top;
        cell[i].onclick = function(){
      ...
      var c = document.getElementById('gameContainer').childNodes;
      for(var i=0;i<size;i++){
        c[i+1].style.background = 'url("peach.jpg")';
        cell[i].style.left = (i%4*100)+'px';
        cell[i].style.top = (parseInt(i/4)*100) + 'px';
        cell[i].style.backgroundPosition= '-' + cell[i].style.left + ' ' + '-' + cell[i].style.top;
        cell[i].onclick = function(){
      ...
      var c = document.getElementById('gameContainer').childNodes;
      for(var i=0;i<size;i++){
        c[i+1].style.background = 'url("bowser.jpg")';
        cell[i].style.left = (i%4*100)+'px';
        cell[i].style.top = (parseInt(i/4)*100) + 'px';
        cell[i].style.backgroundPosition= '-' + cell[i].style.left + ' ' + '-' + cell[i].style.top;
        cell[i].onclick = function(){
      ...
      var c = document.getElementById('gameContainer').childNodes;
      for(var i=0;i<size;i++){
        c[i+1].style.background = 'url("star.jpg")';
        cell[i].style.left = (i%4*100)+'px';
        cell[i].style.top = (parseInt(i/4)*100) + 'px';
        cell[i].style.backgroundPosition= '-' + cell[i].style.left + ' ' + '-' + cell[i].style.top;
        cell[i].onclick = function(){
      ...
      var c = document.getElementById('gameContainer').childNodes;
      for(var i=0;i<size;i++){
        c[i+1].style.background = 'url("mariokart.jpg")';
        cell[i].style.left = (i%4*100)+'px';
        cell[i].style.top = (parseInt(i/4)*100) + 'px';
        cell[i].style.backgroundPosition= '-' + cell[i].style.left + ' ' + '-' + cell[i].style.top;
        cell[i].onclick = function(){
